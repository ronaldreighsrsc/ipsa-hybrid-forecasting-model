...
class HybridARIMALSTMTrainer:
    ...
    def find_best_params(self, train_target: pd.Series, train_exog: pd.DataFrame, lstm_grid: list) -> dict:
        """
        ...
        for params in lstm_grid:
            ...
            for train_idx, val_idx in folds:
                ...
                model_cv = self._build_lstm_classifier((t_steps, n_feat), units=params['units'], dropout=params['dropout'])
